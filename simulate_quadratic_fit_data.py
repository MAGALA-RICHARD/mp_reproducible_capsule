...
if __name__ == '__main__':
    ...
    qp_data_model = create_experiment(base_file='one_file.apsimx', lonlat=None, end=2005,  # lonlatTest,
                                      out_path=apsimx_file_out_path)
    th = [300, 100, 200, 300, 400] * 2
    #qp_data_model.get_weather_from_file('mets/iem_126yrs.met')
    ...
    qp_data_model.edit_model(model_type='Models.Manager', model_name='Tillage', Depth=150)
    qp_data_model.edit_model(model_type='Models.Surface.SurfaceOrganicMatter', model_name='SurfaceOrganicMatter', InitialCNR=20)
    ...
    try:
        ...
        # print('preview the file for any errors in GUI, simulation will resume after this process has terminated')
        ...
        qp_data_model.set_params(path='.Simulations.Experiment.changeFert_verity.Field.Sow using a variable rule',
                                 CultivarName='B_110')
