...
from utils import create_experiment, merge_tables
...
model2 = create_experiment(base_file='base_split_early.apsimx', lonlat=lonlatTest)
...
if __name__ == '__main__':
    ...
    test_mva(model2, table='carbon', title='Moving average SOC', response='min_ratio',
    ...
    test_mva(model2, table='carbon', response='SOC_0_15CM', time_col='year', hue="Nitrogen",
             grouping=("Residue", "Nitrogen"), estimator='mean',
